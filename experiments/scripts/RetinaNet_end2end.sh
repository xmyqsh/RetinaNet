...
#
# Example:
# ./experiments/scripts/RetinaNet_end2end.sh 1 RetinaNet pascal_voc0712 \
...
case $DATASET in
  pascal_voc0712)
    ...
    PT_DIR="pascal_voc"
    ITERS=300000
    CFG="experiments/cfgs/RetinaNet_end2end.yml"
    ;;
  pascal_voc2007)
...
LOG="experiments/logs/RetinaNet_end2end_${NET}_${EXTRA_ARGS_SLUG}.txt.`date +'%Y_%m_%d_%H_%M_%S'`"
exec &> >(tee -a "$LOG")
